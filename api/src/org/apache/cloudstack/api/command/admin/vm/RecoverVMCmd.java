...
@APICommand(name = "recoverVirtualMachine", description="Recovers a virtual machine from Destroyed state and leaves it as Stopped.", responseObject=UserVmResponse.class)
